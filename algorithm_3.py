...
def record_audio_train():
    ...
    for count in range(5):
        ...
        wave_output_file_name = os.path.join("train", "training_set", output_file_name)

        trained_file_list = open("train/training_set_addition.txt", 'a')
...
def train_model():
    source = 'train/training_set/'
    destination = 'train/trained_models/'
    train_file = 'train/training_set_addition.txt'
